...
public class FrameChangeEvent extends ActionEvent implements IFrameChangeEvent {
  ...
  private final EFrameChangeType changeType;
   ...
   * @param changeType {@link EFrameChangeType} type occurring within this keyframe.
   ...
   */
  public FrameChangeEvent(Object source, EFrameChangeType changeType, String name, int tick,
   ...
   */
  @Override
  public EFrameChangeType getType() {
