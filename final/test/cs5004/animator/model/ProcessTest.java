...
public class ProcessTest {
  ...
  public void testConstructorFailsStartBeforeEnd() {
    IProcess move1 = new SuperGeneralProcess("Motion", 5, 10,
  ...
  public void testConstructorFailsNegativeTime() {
    IProcess move1 = new SuperGeneralProcess("Motion", -5, 10, 10,
  ...
  public void testConstructorFailsNegativeWidth() {
    IProcess move1 = new SuperGeneralProcess("Motion", 0, 10, 10,
            -10, 30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0, 0, 0);
  }
  ...
  public void testConstructorFailsBadRGB() {
    IProcess move1 = new GeneralProcess("Motion", 0, 10, 10,
  ...
  public void testGetStartTime() {
    IProcess move1 = new GeneralProcess("Motion", 1, 10, 10,
            10, 30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
    IProcess move2 = new GeneralProcess("Motion", 12, 10, 10,
  ...
  public void testGetEndTime() {
    IProcess move1 = new GeneralProcess("Motion", 0, 10, 10, 10,
            30, 0, 255, 0, 2, 20, 10, 10, 30,
            0, 255, 0);
    IProcess move2 = new GeneralProcess("Motion", 5, 10, 10, 10,
  ...
  public void testGetType() {
    IProcess move1 = new GeneralProcess("Motion", 1, 10, 10, 10,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
    IProcess move2 = new GeneralProcess("Color", 5, 20, 10, 10,
  ...
  public void testGetStartX() {
    IProcess move1 = new GeneralProcess("Motion", 0, 10, 10, 10,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
    IProcess move2 = new GeneralProcess("Motion", 0, 115, 10, 10,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
  ...
  public void testGetStartY() {
    IProcess move1 = new GeneralProcess("Motion", 0, 10, 10, 10,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
    IProcess move2 = new GeneralProcess("Motion", 0, 115, 12, 10,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
  ...
  public void testGetStartWidth() {
    IProcess move1 = new GeneralProcess("Motion", 0, 10, 10, 10,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
    IProcess move2 = new GeneralProcess("Motion", 0, 115, 12, 51,
            30, 0, 255, 0, 5, 20, 10, 10, 30,
            0, 255, 0);
