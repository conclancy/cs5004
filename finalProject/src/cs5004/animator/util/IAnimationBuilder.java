 ...
 */
public interface IAnimationBuilder<Doc> {
  /**
   ...
   */
  IAnimationBuilder<Doc> setBounds(int x, int y, int width, int height);
   ...
   * @return This {@link IAnimationBuilder}
   */
  IAnimationBuilder<Doc> declareShape(String name, String type);
   ...
   * @return This {@link IAnimationBuilder}
   */
  IAnimationBuilder<Doc> addMotion(String name,
