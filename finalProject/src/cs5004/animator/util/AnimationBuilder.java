...
public class AnimationBuilder implements IAnimationBuilder {
   ...
   */
  @Override
  public IAnimationBuilder addMotion(String name, int t1, int x1, int y1, int w1, int h1, int r1,
      int g1, int b1, int t2, int x2, int y2, int w2, int h2, int r2, int g2, int b2) {

    this.model.addAnimation(name, new ChangeColor(t1, t2, r1, g1, b1, r2, g2, b2));
    this.model.addAnimation(name, new Move(t1, t2, x1, y1, x2, y2));
    this.model.addAnimation(name, new Resize(t1, t2, w1, h1, w2, h2));
