...
public class AnimationReader {
   ...
   * @return
   */
  public static <Doc> Doc parseFile(Readable readable, IAnimationBuilder<Doc> builder) {
  ...
  private static <Doc> void readCanvas(Scanner s, IAnimationBuilder<Doc> builder) {
    int[] vals = new int[4];
  ...
  private static <Doc> void readShape(Scanner s, IAnimationBuilder<Doc> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
  ...
  private static <Doc> void readMotion(Scanner s, IAnimationBuilder<Doc> builder) {
