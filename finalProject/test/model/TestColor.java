...
public class TestColor {
  ...
  public void testGetRGB() {
    assertEquals("rgb(255, 255, 255)", whiteInt.getRGB());
    assertEquals("rgb(255, 255, 255)", whiteHex.getRGB());
    assertEquals("rgb(0, 0, 0)", blackInt.getRGB());
    assertEquals("rgb(0, 0, 0)", blackHex.getRGB());
    assertEquals("rgb(127, 255, 212)", aquamarineInt.getRGB());
    assertEquals("rgb(127, 255, 212)", aquamarineHex.getRGB());
    assertEquals("rgb(201, 20, 60)", softRedInt.getRGB());
    assertEquals("rgb(201, 20, 60)", softRedHex.getRGB());
  }
